      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <x-form-field>
            ...
            <div class="mt-2">
              <x-form-input name="title" id="title" placeholder="Terrorist sleeping cell" required/>
          ...
          <x-form-field>
            ...
            <div class="mt-2">
              <x-form-input name="salary" id="salary" placeholder="$10 dollar per year" required/>
